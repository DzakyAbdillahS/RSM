...
use App\Exports\MduPlnGarduExport;

class MduPlnGarduController extends Controller
{
    public function index($id, $id_jenis_monitoring)
    {
        ...
        return view('page.monitoring.MduPlnGardu',[
            'datas'=>$datas,
            'jenis'=>$jenis,
            'details'=>$details,
            'id_mdu_pln_gardu'=>$id_mdu_pln_gardu
    ...
    public function excelMduPlnGardu($id)
    {
        return Excel::download(new MduPlnGarduExport($id), 'MduPlnGardu.xlsx');
    }
}
