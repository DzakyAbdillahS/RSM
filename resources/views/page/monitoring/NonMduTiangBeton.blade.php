    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col">
                ...
                <h5 class="text-center mt-1 mb-3 text-bold">Non MDU Tiang Beton</h5>
                ...
                <a href="{{ route('NonMduTiangBeton.excelNonMduTiangBeton', $id_non_mdu_tiang_beton) }}" class="btn btn-success mt-3 ml-2">Excel</a>
        ...
        <div class="row">
            <div class="col">
                <table id="tbl_non_mdu_tiang_beton" class="display nowrap" style="width:100%">
                    <thead>
                      <tr>
                        <th scope="col">No</th>
                        ...
                        <th scope="col">UNP HODIP</th>
                        <th scope="col">PLAT LAYANG</th>
                        <th scope="col">D. ARMING 5/8</th>
                        <th scope="col">MUR+RING 5/8</th>
                        <th scope="col">BAUT 5/8x2</th>
                        <th scope="col">BEUGLE 8"</th>
                        <th scope="col">ANCHOR</th>
                        <th scope="col">SLING 8"</th>
                        <th scope="col">PINEX 3/8</th>
                        <th scope="col">SPANSCROF 16"</th>
                        <th scope="col">TUI TM</th>
                        <th scope="col">KAOS BAJA</th>
                        <th scope="col">BETON BLOK</th>
                        <th scope="col">TUSUK KONDE</th>
                                    ...
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('NonMduTiangBeton.update', $detail->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form">
                                                    @method('put')
                                    ...
                                    <div class="modal-dialog modal-sm">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form action="{{ route('NonMduTiangBeton.destroy', $detail->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col" class="text-center">{{ $m14 }}</th>
                            <th scope="col" class="text-center"></th>
                        </tr>
                    </tfoot>
                  </table>
  ...
  <div class="modal fade" id="modal-create">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('NonMduTiangBeton.store', [$jenis->id_pekerjaan, $id_non_mdu_tiang_beton]) }}" enctype="multipart/form-data">
                @csrf
                <div class="form">
                    <div class="form-group">
                        <label for="uraian_pekerjaan">Uraian Pekerjaan</label>
                    ...
                    <div class="form-group">
                        {{-- <label for="id_jenis_monitoring">Id Jenis Monitoring</label> --}}
                        <input type="hidden" value="{{ $id_non_mdu_tiang_beton }}" class="form-control" id="id_jenis_monitoring" name="id_jenis_monitoring">
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
